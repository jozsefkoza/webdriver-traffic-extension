...
/**
 * A {@link NetworkTrafficSource} which returns all the captured traffic by {@link BrowserMobProxy}.
 *
 * @author JoeZee
 */
public final class BrowserMobBasedTrafficSource implements NetworkTrafficSource {
